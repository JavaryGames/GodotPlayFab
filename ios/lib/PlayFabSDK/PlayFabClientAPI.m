...
-(void) ConsumePSNEntitlements:(ClientConsumePSNEntitlementsRequest*)request success:(ConsumePSNEntitlementsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientConsumePSNEntitlementsRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientConsumePSNEntitlementsResult *model = [[ClientConsumePSNEntitlementsResult new] initWithDictionary:class_data];
...
-(void) GetPlayFabIDsFromPSNAccountIDs:(ClientGetPlayFabIDsFromPSNAccountIDsRequest*)request success:(GetPlayFabIDsFromPSNAccountIDsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientGetPlayFabIDsFromPSNAccountIDsRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientGetPlayFabIDsFromPSNAccountIDsResult *model = [[ClientGetPlayFabIDsFromPSNAccountIDsResult new] initWithDictionary:class_data];
...
-(void) GetPlayFabIDsFromXboxLiveIDs:(ClientGetPlayFabIDsFromXboxLiveIDsRequest*)request success:(GetPlayFabIDsFromXboxLiveIDsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientGetPlayFabIDsFromXboxLiveIDsRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientGetPlayFabIDsFromXboxLiveIDsResult *model = [[ClientGetPlayFabIDsFromXboxLiveIDsResult new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/GetPlayFabIDsFromXboxLiveIDs"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
...
-(void) LinkOpenIdConnect:(ClientLinkOpenIdConnectRequest*)request success:(LinkOpenIdConnectCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLinkOpenIdConnectRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LinkOpenIdConnect"] body:jsonString authType:@"X-Authorization" authKey:self.mUserSessionTicket];
}
-(void) LinkPSNAccount:(ClientLinkPSNAccountRequest*)request success:(LinkPSNAccountCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLinkPSNAccountRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientLinkPSNAccountResult *model = [[ClientLinkPSNAccountResult new] initWithDictionary:class_data];
...
-(void) LoginWithOpenIdConnect:(ClientLoginWithOpenIdConnectRequest*)request success:(LoginWithOpenIdConnectCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLoginWithOpenIdConnectRequest class]];
...
if(model.SettingsForUser.NeedsAttribution)
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Client/LoginWithOpenIdConnect"] body:jsonString authType:nil authKey:nil];
}
...
-(void) LoginWithPSN:(ClientLoginWithPSNRequest*)request success:(LoginWithPSNCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientLoginWithPSNRequest class]];
...
-(void) RefreshPSNAuthToken:(ClientRefreshPSNAuthTokenRequest*)request success:(RefreshPSNAuthTokenCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[ClientRefreshPSNAuthTokenRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                ClientUnlinkPSNAccountResult *model = [[ClientUnlinkPSNAccountResult new] initWithDictionary:class_data];
